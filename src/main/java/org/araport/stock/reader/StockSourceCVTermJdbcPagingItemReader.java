...
@Component("source_stock_cvterm_reader")
...
public class StockSourceCVTermJdbcPagingItemReader {

	private static final Logger log = Logger
			.getLogger(StockSourceCVTermJdbcPagingItemReader.class);
	...
	@Autowired
	StockCVTermSourceRowMapper stockCVTermSourceRowMapper;
	
	 @Value("${stock_cvterm.select.clause}")
	 private String selectClause;
	 
	 @Value("${stock_cvterm.where.clause}")
	 private String whereClause;
	 
	 @Value("${stock_cvterm.from.clause}")
	 private String fromClause;
	 
	 @Value("${stock_cvterm.sortkey}")
	 private String sortKey;
	 
	 @Value("${stock_cvterm.page.size}")
	 private int pageSize;
		
	@Bean
	@StepScope
	public JdbcPagingItemReader<StockCVTermSource> sourceStockCVTermItemReader(
		...
		JdbcPagingItemReader<StockCVTermSource> reader = new JdbcPagingItemReader<StockCVTermSource>();
		...
		reader.setRowMapper(stockCVTermSourceRowMapper);
