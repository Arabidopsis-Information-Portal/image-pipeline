...
public class BulkLoadStockCVTermTasklet implements Tasklet {

	private static final Log log = LogFactory
			.getLog(BulkLoadStockCVTermTasklet.class);
	...
	private static final String POPULATE_CHADO_STOCK_CVTERM_SQL_PATH = "/sql/transformations/stock_properties/populate_chado_stock_cvterm.sql";
	private static final String POPULATE_CHADO_STOCK_CVTERM_SQL = FileUtils
			.getSqlFileContents(POPULATE_CHADO_STOCK_CVTERM_SQL_PATH);
	...
	public RepeatStatus execute(StepContribution step, ChunkContext context)
		...
		log.info("Populate Chado Stock CVTerm Table SQL:"
				+ POPULATE_CHADO_STOCK_CVTERM_SQL);
		log.info("Populating Chado Stock CVTerm Table...");

		generalDao.executeSQL(POPULATE_CHADO_STOCK_CVTERM_SQL);
